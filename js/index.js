...
//音量进度条
    //虚假例子
        ...
        var btnclose=document.querySelector('.close_list');
   ...
   //切歌
    ...
    var yinyueku=[
    {name:'我们在改变',src:'music/001.mp3',geshou:'魏晨',duration:'4:02'},
    {name:'爱',src:'music/111.mp3',geshou:'A-Lin',duration:'4:13'},
    {name:'爱你的宿命',src:'music/22.mp3',geshou:'The-one',duration:'5:44'},
    {name:'生如夏花',src:'music/222.mp3',geshou:'zhanglianying',duration:'5:20'},
    {name:'胡歌 - 忘记时间',src:'music/002.mp3',geshou:'胡歌',duration:'4:32'},
    {name:'张敬轩-吻得太逼真',src:'music/003.mp3',geshou:'张敬轩',duration:'3:51'},
    {name:'(猫步轻悄)',src:'music/004.mp3',geshou:'AOA (에이오에이)',duration:'3:39'},
    {name:'짧은 치마 (短裙)',src:'music/005.mp3',geshou:'AOA (에이오에이)',duration:'2:59'},
    {name:'模特',src:'music/006.mp3',geshou:'李荣浩',duration:'5:06'},
    {name:'信仰',src:'music/007.mp3',geshou:'张信哲',duration:'4:12'}
    ];
